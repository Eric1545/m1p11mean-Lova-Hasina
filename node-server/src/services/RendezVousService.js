...
async function rappelleRendezVous(){
    ...
    for (const rendezVousItem of rendezVous) {
        ...
        await envoyerEmail(rendezVousItem.client_id.email, "Rappel de rendez-vous", `Vous avez un rendez-vous pour le ${date_insertion.toLocaleDateString('fr-FR')} à ${date_insertion.toLocaleTimeString()} !`);
    }
